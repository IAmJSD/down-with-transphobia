...
<html lang="en">
    <head>
        ...
        <meta property="og:description" content="A project to send a message to the UK government that transphobia isn't okay.">
    ...
    <body>
        ...
        <div class="container">
            ...
            <p>
                <?php
                echo nl2br('The UK government recently put out <a href="https://www.gov.uk/government/consultations/toilet-provision-for-men-and-women-call-for-evidence/toilet-provision-for-men-and-women-call-for-evidence">a open consultation</a> calling for provisions on public toilets and adding that building standards guidance should have a "steer clear" of gender neutral bathrooms. This is making the government stance that gender neutral bathrooms are wrong. Considering the anti-LGBTQ+ views from this government, it is clear this is a transphobic dog-whistle, especially since the arguments raised are misinformed.
