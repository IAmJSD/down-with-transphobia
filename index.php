...
if ($_SERVER["REQUEST_METHOD"] === "POST") {
    ...
    try {
        ...
        $gen = uniqid();
        if (!pg_insert($pgConn, "letters", array("id" => $gen, "email" => $email), PGSQL_DML_ESCAPE)) throw new Exception(pg_last_error($pgConn));
        $senderId = $gen;
        ...
        $email->addTo("jake@gealer.email", "Toilets Review");
